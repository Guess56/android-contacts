...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> implements ListDiffInterface<ContactAdapter> {
    ...
    @Override
    public boolean theSameAs(ContactAdapter contactAdapter) {
        return this.hashCode() == contactAdapter.hashCode();
    }
