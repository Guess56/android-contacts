...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> implements ListDiffInterface<FilterContactTypeAdapter> {
    ...
    @Override
    public boolean theSameAs(FilterContactTypeAdapter filterContactTypeAdapter) {
        return this.hashCode() == filterContactTypeAdapter.hashCode();
    }
