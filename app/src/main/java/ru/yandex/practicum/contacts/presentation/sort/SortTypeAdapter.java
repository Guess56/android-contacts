...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> implements ListDiffInterface<SortTypeAdapter> {
    ...
    @Override
    public boolean theSameAs(SortTypeAdapter sortTypeAdapter) {
        return this.hashCode() == sortTypeAdapter.hashCode();
    }
